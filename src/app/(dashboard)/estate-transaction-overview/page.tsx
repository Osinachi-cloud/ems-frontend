...
const AdminPage = () => {
    ...
    const buildTransactionStatsUrl = () => {
        let url = `${baseUrL}/get-estate-transaction-stats?estateId=${estateId}`;
            ...
            <div className="p-4 flex gap-4 flex-col md:flex-row">
                ...
                <div className="w-full flex flex-col gap-8">
                    ...
                    <div>
                        ...
                        <h6 className="text-xl text-blue-600 mb-4 flex justify-between">
                            <span>
                        ...
                        {statsLoading ? (
                            ...
                            <>
                                <UserCard
                                    ...
                                    value={formatNumberToNaira(transactionStats?.data?.totalSuccessfulAmountPaid) || 0}
                                    isAmount={true}
                                    bgColor={"teal"}
                                />
                                <UserCard
                                    label="Total Fail Payments"
                                    value={formatNumberToNaira(transactionStats?.data?.totalFailedAmountPaid)}
                                    isDate={true}
                                    bgColor={"red"}
                                ...
                                <UserCard
                                    ...
                                    value={transactionStats?.data?.totalFailedTransactions}
                                    isDate={true}
                                    bgColor={"orange"}
                                ...
                                <UserCard
                                    ...
                                    value={transactionStats?.data?.totalSuccessfulTransactions}
                                    isDate={true}
                                    bgColor={"blue"}
                                />
                            </>
